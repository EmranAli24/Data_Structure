...
Nodes are labeled from 0 to n-1, the task is to find the shortest distance from the source node to all other nodes.
 Output “-1” if there exists a negative edge weight cycle in the graph.
